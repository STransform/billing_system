...
INSTALLED_APPS = [
    ...
    'core.apps.CoreConfig', # Added by Lelisa
    'accounts' # Added by Lelisa
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "templates"], #added by Lelisa
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Email (adjust with your real SMTP)
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'billing@ocloud.com'
